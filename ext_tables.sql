CREATE TABLE tx_bwrkmarkermap_domain_model_marker (
	...
	zip varchar(255) DEFAULT '0' NOT NULL,
...
CREATE TABLE tx_bwrkmarkermap_domain_model_marker_style (
	...
	title varchar(255) DEFAULT '0' NOT NULL,
	fill_color varchar(255) DEFAULT '0' NOT NULL,
	fill_opacity varchar(255) DEFAULT '0' NOT NULL,
	scale varchar(255) DEFAULT '0' NOT NULL,
	anchor varchar(255) DEFAULT '0' NOT NULL,
	svg_path text,
